...
#include "../../../../include/GUI/mapscene.h"
...
static constexpr auto qt_meta_stringdata_ZN8MapSceneE = QtMocHelpers::stringData(
    "MapScene"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN8MapSceneE[] = {
...
Q_CONSTINIT const QMetaObject MapScene::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8MapSceneE.offsetsAndSizes,
    qt_meta_data_ZN8MapSceneE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8MapSceneE_t,
        // Q_OBJECT / Q_GADGET
...
void *MapScene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8MapSceneE.stringdata0))
