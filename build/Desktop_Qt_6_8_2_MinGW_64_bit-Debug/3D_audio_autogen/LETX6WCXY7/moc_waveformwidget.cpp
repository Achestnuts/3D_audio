...
#include "../../../../include/GUI/waveformwidget.h"
...
static constexpr auto qt_meta_stringdata_ZN14WaveformWidgetE = QtMocHelpers::stringData(
    "WaveformWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14WaveformWidgetE[] = {
...
Q_CONSTINIT const QMetaObject WaveformWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14WaveformWidgetE.offsetsAndSizes,
    qt_meta_data_ZN14WaveformWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14WaveformWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *WaveformWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14WaveformWidgetE.stringdata0))
