...
#include "../../../../include/GUI/parameterwidget.h"
...
static constexpr auto qt_meta_stringdata_ZN15ParameterWidgetE = QtMocHelpers::stringData(
    "ParameterWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15ParameterWidgetE[] = {
...
Q_CONSTINIT const QMetaObject ParameterWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15ParameterWidgetE.offsetsAndSizes,
    qt_meta_data_ZN15ParameterWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15ParameterWidgetE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ParameterWidget, std::true_type>
    >,
    nullptr
} };
...
void *ParameterWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15ParameterWidgetE.stringdata0))
